...
function AiModal({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    <>
      ...
      />
      <div 
        className="fixed left-1/2 top-1/2 z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800"
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-indigo-600 dark:text-indigo-400">Coming Soon</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-3 mt-6">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Smart task suggestions based on your workflow</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="mt-0.5 h-1.5 w-1.5 rounded-full bg-indigo-500 shrink-0" />
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Auto scheduling to optimize your calendar</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="mt-0.5 h-1.5 w-1.5 rounded-full bg-indigo-500 shrink-0" />
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Task summaries and progress insights</p>
          </div>
          <div className="flex items-start gap-3 opacity-60">
            <div className="mt-0.5 h-1.5 w-1.5 rounded-full bg-indigo-500 shrink-0" />
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Voice input <span className="text-[10px] uppercase tracking-wider ml-1 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded text-zinc-500">(Future)</span></p>
          </div>
        </div>
        
        <button
          onClick={onClose}
          className="mt-8 w-full rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white transition-colors"
        >
          Got it
        </button>
      </div>
...
export function Sidebar({ userEmail, onSignOut }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col w-60 border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      {/* Logo */}
      <div className="flex items-center gap-2.5 h-14 px-5 border-b border-zinc-100 dark:border-zinc-800/80">
        ...
        <div className="space-y-1">
          ...
          <nav className="space-y-0.5">
            <button
              ...
              className="w-full flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm font-medium text-indigo-500 hover:bg-indigo-50/50 hover:text-indigo-700 dark:text-indigo-400 dark:hover:bg-indigo-900/20 dark:hover:text-indigo-300 transition-colors"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z" />
              </svg>
